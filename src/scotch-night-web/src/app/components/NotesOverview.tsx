...
import VictoryBar from 'victory-chart/es/components/victory-bar/victory-bar';
import VictoryChart from 'victory-chart/es/components/victory-chart/victory-chart';
import VictoryPolarAxis from 'victory-chart/es/components/victory-polar-axis/victory-polar-axis';
...
const Center = props => {
    ...
    return (
        <g>
            <circle cx={origin.x} cy={origin.y} r={30} style={circleStyle} />
        </g>
    );
};
...
const CenterLabel = props => {
    ...
    const style = [{ ...baseStyle, fontSize: 10, fontWeight: 'bold' }, { ...baseStyle, fontSize: 8 }];

    if (active) {
        return <VictoryLabel text={text} style={style} x={175} y={150} />;
    }
        ...
        return (
            <div className="bottle-overview">
                ...
                <div className="margin-bottom-md">
                    ...
                    >
                        <Center />
                        <VictoryPolarAxis labelPlacement="parallel" style={{ tickLabels: { fontSize: 10 } }} />
                        <VictoryPolarAxis
                            dependentAxis
                            style={{
                                axis: { stroke: 'none' },
                ...
                <div className="text-xs">
                    <em>* Based on flavor profile selections</em>
                </div>
            </div>
        );
    }
